 ...
 */
final class Version20230113114654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE relationship (id INT NOT NULL, first_id INT NOT NULL, second_id INT NOT NULL, some_other_stuff VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
